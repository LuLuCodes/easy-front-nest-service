...
@Table({ tableName: "t_customer_photo", timestamps: false, comment: "\u7528\u6237\u76F8\u518C" })
export class TCustomerPhoto extends Model {
    ...
    customer_id?: number;
    @Column({ allowNull: true, type: DataType.TINYINT, comment: "\u76F8\u518C\u7C7B\u578B:0:\u666E\u901A 1:\u771F\u4EBA2:\u5973\u795E,3\u9605\u540E\u5373\u711A,4:\u4ED8\u8D39,\u5982\u679C\u662F1\u5220\u9664\u89E6\u53D1\u5220\u51FA\u8BA4\u8BC1" })
    photo_type?: number;
    ...
    pic_url_ext?: string;
    @Column({ allowNull: true, type: DataType.TINYINT, comment: "\u5BA1\u6838\u6807\u8BB0 1\u5BA1\u6838 0\u672A\u5BA1\u6838 11\u5BA1\u6838\u5931\u8D25 12\u9700\u8981\u4EBA\u5DE5\u5BA1\u6838" })
    audit_status?: number;
