...
@Table({ tableName: "t_spu_check_log", timestamps: false, comment: "\u7CFB\u7EDF\u5F02\u5E38\u8B66\u544A\u8868" })
export class TSpuCheckLog extends Model {
    ...
    product_sn!: string;
    @Column({ type: DataType.INTEGER, comment: "\u7C7B\u578B\uFF081\u5546\u54C1\u66F4\u65B0 2\u8FD0\u8D39\u6A21\u677F\u66F4\u65B0 3\u4E0D\u53EF\u552E\u533A\u57DF\u66F4\u65B0 4\u5E97\u94FA\u66F4\u65B0\uFF09" })
    action_type!: number;
    @Column({ type: DataType.INTEGER, comment: "\u662F\u5426\u6210\u529F\uFF081\u6210\u529F 0\u5931\u8D25\uFF09" })
    if_success!: number;
    @Column({ allowNull: true, type: DataType.STRING(1000), comment: "\u5931\u8D25\u5907\u6CE8" })
    remark?: string;
