...
export class TAdminMenu extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u83DC\u5355\u4E3B\u952E" })
    ...
    parent_id!: number;
    @Column({ allowNull: true, type: DataType.TINYINT, comment: "\u6743\u9650\u7C7B\u578B 1\u76EE\u5F55 2\u83DC\u5355 3\u6309\u94AE" })
    right_type?: number;
    @Column({ allowNull: true, type: DataType.STRING(100), comment: "\u83DC\u5355\u540D\u79F0" })
    title?: string;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u83DC\u5355\u7EA7\u6570", defaultValue: "0" })
    level?: number;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u83DC\u5355\u6392\u5E8F", defaultValue: "0" })
    sort?: number;
    @Column({ allowNull: true, type: DataType.STRING(50), comment: "\u524D\u7AEF\u8DEF\u7531name" })
    show_name?: string;
    ...
    layout?: string;
    @Column({ allowNull: true, type: DataType.STRING(50), comment: "\u524D\u7AEF\u8DEF\u7531path" })
    show_path?: string;
    @Column({ type: DataType.TINYINT, comment: "0 \u53EF\u7528, 1 \u7981\u7528, 2 \u4E0D\u5C55\u793A" })
    status!: number;
    @Column({ allowNull: true, type: DataType.STRING(500), comment: "\u989D\u5916\u7684\u5B57\u6BB5" })
    extra?: string;
