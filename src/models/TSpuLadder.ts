...
@Table({ tableName: "t_spu_ladder", timestamps: false, comment: "\u5546\u54C1(SPU)\u9636\u68AF\u4EF7\u683C\u8868(\u53EA\u9488\u5BF9\u540CSPU)" })
export class TSpuLadder extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u4EF7\u683C\u4E3B\u952E" })
    ...
    product_id!: number;
    @Column({ type: DataType.INTEGER, comment: "\u6EE1\u8DB3\u7684\u5546\u54C1\u6570\u91CF", defaultValue: "0" })
    count?: number;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u6298\u6263", defaultValue: "0.00" })
    discount?: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u6298\u540E\u4EF7\u683C", defaultValue: "0.00" })
    price?: string;
