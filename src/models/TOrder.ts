...
export class TOrder extends Model {
  ...
  @Column({
    ...
    type: DataType.TINYINT,
    comment:
      '\u8BA2\u5355\u7C7B\u578B\uFF1A0->\u6B63\u5E38\u8BA2\u5355\uFF1B1->\u79D2\u6740\u8BA2\u5355  2->\u62A5\u5173\u8BA2\u5355  3->\u5361\u5238\u8BA2\u5355 4->\u9152\u5E97\u8BA2\u5355 5->\u76F4\u51B2\u5546\u54C1 6->\u79F0\u91CD\u8BA2\u5355',
  })
  order_type?: number;
  ...
  @Column({
    type: DataType.INTEGER,
    comment:
      '\u4E09\u65B9\u5F02\u5E38\u5355\u8B66\u544A\uFF083\u8BA2\u5355\u5907\u6CE8\u8B66\u544A 2\u6570\u91CF\u8B66\u544A 1\u91D1\u989D\u8B66\u544A 0\u6B63\u5E38\uFF09',
    defaultValue: '0',
  })
  ...
  @Column({
    type: DataType.INTEGER,
    comment:
      '\u4E09\u65B9\u539F\u5355\u53F7\u586B\u5145\u5730\u5740\u72B6\u6001\uFF080\u5F85\u586B\u5145 1\u586B\u5145\u4E2D 2\u5DF2\u586B\u5145 11\u586B\u5145\u5931\u8D25\uFF09',
    defaultValue: '0',
  })
  ...
  @Column({
    type: DataType.INTEGER,
    comment:
      '\u8BA4\u9886\u540E\u5E73\u53D1\u8D27\u53F0\u540C\u6B65\u72B6\u6001\uFF080\u5F85\u540C\u6B65 10\u540C\u6B65\u6210\u529F 11\u540C\u6B65\u5931\u8D25\uFF09',
    defaultValue: '0',
  })
