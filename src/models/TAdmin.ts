...
export class TAdmin extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u540E\u53F0\u7528\u6237\u4E3B\u952E" })
    ...
    admin_code!: string;
    @Column({ type: DataType.INTEGER, comment: "\u8D26\u53F7\u6765\u6E90\uFF080\u5E73\u53F0\u540E\u53F0 1\u5546\u5BB6\u540E\u53F0\uFF09", defaultValue: "0" })
    source_type?: number;
    @Column({ type: DataType.BIGINT, comment: "\u8D26\u53F7\u6765\u6E90\u7F16\u7801", defaultValue: "0" })
    source_id?: number;
    @Column({ type: DataType.INTEGER, comment: "\u6E20\u9053\u7C7B\u578B\uFF080\u666E\u901A 1\u6E20\u9053\uFF09", defaultValue: "0" })
    source_class?: number;
    @Column({ allowNull: true, type: DataType.DATE, comment: "\u6700\u540E\u767B\u5F55\u65F6\u95F4" })
    last_login_time?: Date;
    @Column({ type: DataType.INTEGER, comment: "\u662F\u5426\u9ED8\u8BA4\u4F4F\u8D26\u53F7", defaultValue: "0" })
    is_default?: number;
