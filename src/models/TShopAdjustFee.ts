...
@Table({ tableName: "t_shop_adjust_fee", timestamps: false, comment: "\u5E97\u94FA\u53D8\u52A8\u6210\u672C" })
export class TShopAdjustFee extends Model {
    ...
    shop_id!: number;
    @Column({ type: DataType.DATE, comment: "\u53D8\u52A8\u6210\u672C\u65F6\u95F4" })
    fee_date!: Date;
    @Column({ type: DataType.STRING(100), comment: "\u53D8\u52A8\u6210\u672C\u6807\u9898" })
    title!: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u53D8\u52A8\u6210\u672C", defaultValue: "0.00" })
    amount?: string;
