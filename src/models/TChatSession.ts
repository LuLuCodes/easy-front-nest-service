...
@Table({ tableName: "t_chat_session", timestamps: false, comment: "\u804A\u5929\u4F1A\u8BDD\u8868-\u6700\u8FD1\u8054\u7CFB\u4EBA" })
export class TChatSession extends Model {
    ...
    @Index({ name: "idx_last_msg_id", using: "BTREE", order: "ASC", unique: false })
    last_msg_id?: number;
    @Column({ type: DataType.INTEGER, comment: "\u672A\u8BFB\u6D88\u606F\u6570\u91CF", defaultValue: "0" })
    no_read_count?: number;
    @Column({ allowNull: true, type: DataType.TINYINT, comment: "\u670B\u53CB\u5173\u7CFB 0 1\u62C9\u9ED1" })
