...
@Table({ tableName: "t_object_wallet", timestamps: false, comment: "\u5BF9\u8C61\u94B1\u5305\u8868" })
export class TObjectWallet extends Model {
    ...
    app_id?: number;
    @Column({ type: DataType.BIGINT, comment: "\u5BF9\u8C61\u7F16\u7801\uFF08\u5546\u5BB6\u7F16\u7801\uFF09" })
    @Index({ name: "idx_object_id", using: "BTREE", order: "ASC", unique: false })
    object_id!: number;
    @Column({ type: DataType.INTEGER, comment: "\u5BF9\u8C61\u7C7B\u578B\uFF081\u5546\u5BB6seller\uFF09" })
    object_type!: number;
    @Column({ type: DataType.INTEGER, comment: "\u94B1\u5305\u7C7B\u578B(1\u666E\u901A\u94B1\u5305)" })
    wallet_type!: number;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u94B1\u5305\u4F59\u989D", defaultValue: "0.00" })
    amount?: string;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u51FA\u8D26\u51BB\u7ED3", defaultValue: "0.00" })
    out_frozen_amount?: string;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u8FDB\u5E10\u51BB\u7ED3", defaultValue: "0.00" })
