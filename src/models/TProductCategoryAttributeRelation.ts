...
@Table({ tableName: "t_product_category_attribute_relation", timestamps: false, comment: "\u5546\u54C1\u7C7B\u76EE\u548C\u5C5E\u6027\u5173\u7CFB\u8868" })
export class TProductCategoryAttributeRelation extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u5173\u7CFB\u4E3B\u952E" })
    ...
    @Index({ name: "idx_product_category_id", using: "BTREE", order: "ASC", unique: false })
    product_category_id!: string;
    @Column({ type: DataType.BIGINT, comment: "\u5546\u54C1\u5C5E\u6027\u4E3B\u952E" })
    @Index({ name: "idx_product_attribute_id", using: "BTREE", order: "ASC", unique: false })
