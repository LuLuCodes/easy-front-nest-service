...
@Table({ tableName: "t_bank_transfer_service_fee", timestamps: false, comment: "\u5F52\u96C6\u8D26\u53F7\u6253\u5230\u652F\u4ED8\u5B9DB\u7684\u8865\u5145\u624B\u7EED\u8D39\u8868" })
export class TBankTransferServiceFee extends Model {
    ...
    ali_amount!: string;
    @Column({ allowNull: true, type: DataType.STRING(500), comment: "\u652F\u4ED8\u5B9D\u8F6C\u8D26\u5904\u7406\u7ED3\u679C" })
    ali_remark?: string;
