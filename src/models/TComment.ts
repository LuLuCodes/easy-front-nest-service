...
export class TComment extends Model {
    ...
    app_id?: number;
    @Column({ type: DataType.INTEGER, comment: "\u8BC4\u8BBA\u7C7B\u578B\uFF081\u8BC4\u8BBA 2\u70B9\u8D5E\uFF09" })
    comment_type!: number;
    @Column({ type: DataType.BIGINT })
    @Index({ name: "idx_customer_id", using: "BTREE", order: "ASC", unique: false })
    customer_id!: number;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u6765\u6E90\uFF081\u52A8\u6001\uFF09" })
    @Index({ name: "idx_source_id", using: "BTREE", order: "ASC", unique: false })
    source_type?: number;
    @Column({ allowNull: true, type: DataType.BIGINT, comment: "\u6765\u6E90\u7F16\u7801\uFF081\u52A8\u6001\u7F16\u7801\uFF09" })
    @Index({ name: "idx_source_id", using: "BTREE", order: "ASC", unique: false })
    source_id?: number;
    ...
    @Column({ allowNull: true, type: DataType.STRING(50), comment: "\u56DE\u590D\u5BF9\u8C61\u6635\u79F0" })
    to_customer_nick?: string;
    @Column({ type: DataType.TINYINT, comment: "\u662F\u5426\u5DF2\u8BFB", defaultValue: "0" })
    if_read?: number;
    @Column({ type: DataType.TINYINT, comment: "\u662F\u5426\u662F\u6839\u8BC4\u8BBA", defaultValue: "1" })
    if_root?: number;
