...
@Table({ tableName: "t_customer_level", timestamps: false, comment: "\u7528\u6237\u7B49\u7EA7\u8868" })
export class TCustomerLevel extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.INTEGER, comment: "\u7528\u6237\u7B49\u7EA7\u4E3B\u952E(\u81EA\u589E)" })
    ...
    @Index({ name: "idx_customer_level_name", using: "BTREE", order: "ASC", unique: false })
