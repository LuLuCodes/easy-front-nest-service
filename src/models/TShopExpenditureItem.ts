...
@Table({ tableName: "t_shop_expenditure_item", timestamps: false, comment: "\u5E97\u94FA\u989D\u5916\u5F00\u652F\u8868\u660E\u7EC6\u8868" })
export class TShopExpenditureItem extends Model {
    ...
    @Index({ name: "idx_shop_expenditure_id", using: "BTREE", order: "ASC", unique: false })
    shop_expenditure_id!: number;
    @Column({ type: DataType.DATE, comment: "\u5F00\u652F\u8D77\u59CB\u65F6\u95F4\uFF08\u5305\u62EC\u8FD9\u4E2A\u70B9\uFF09" })
    start_time!: Date;
    @Column({ type: DataType.DATE, comment: "\u5F00\u652F\u7ED3\u675F\u65F6\u95F4\uFF08\u4E0D\u5305\u62EC\u8FD9\u4E2A\u70B9\uFF09" })
    end_time!: Date;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u91D1\u989D", defaultValue: "0.00" })
    const?: string;
