...
export class TOrderWork extends Model {
    ...
    @Column({ allowNull: true, type: DataType.STRING(300), comment: "\u6B3E\u540D\u79F0\uFF08\u9ED8\u8BA4\u53D61\u4E2A\uFF09" })
    product_sn?: string;
    @Column({ allowNull: true, type: DataType.STRING(2000), comment: "\u6B3E\u4E3B\u56FE\uFF08\u9ED8\u8BA4\u53D61\u4E2A\uFF09" })
    pic_url?: string;
    ...
    @Column({ type: DataType.INTEGER, comment: "\u5DE5\u5355\u72B6\u6001\uFF081\u5F85\u8FD0\u8425\u5904\u7406 2\u5F85\u5BA2\u670D\u5904\u7406 3\u5173\u95ED\uFF09", defaultValue: "1" })
    work_status?: number;
    ...
    last_deal_time?: Date;
    @Column({ allowNull: true, type: DataType.STRING(100), comment: "\u6700\u540E\u5904\u7406\u521B\u5EFA\u4EBA" })
    ...
    @Column({ allowNull: true, type: DataType.STRING, comment: "\u6700\u540E\u5904\u7406\u9644\u4EF6\uFF08JSON\uFF09" })
