...
@Table({ tableName: "t_admin_shop_group_relation", timestamps: false, comment: "\u7BA1\u7406\u5458\u5E97\u94FA\u5206\u7EC4\u5173\u7CFB\u8868" })
export class TAdminShopGroupRelation extends Model {
    ...
    app_id?: number;
    @Column({ type: DataType.BIGINT, comment: "\u7BA1\u7406\u5458\u7CFB\u7EDF\u7F16\u7801" })
    @Index({ name: "idx_admin_id", using: "BTREE", order: "ASC", unique: false })
    admin_id!: number;
    @Column({ type: DataType.BIGINT, comment: "\u5E97\u94FA\u5206\u7EC4\u7CFB\u7EDF\u7F16\u7801" })
