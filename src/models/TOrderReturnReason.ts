...
@Table({ tableName: "t_order_return_reason", timestamps: false, comment: "\u9000\u8D27\u539F\u56E0\u8868" })
export class TOrderReturnReason extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.INTEGER, comment: "\u9000\u8D27\u539F\u56E0\u4E3B\u952E" })
    @Index({ name: "PRIMARY", using: "BTREE", order: "ASC", unique: true })
    id?: number;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u5E94\u7528id", defaultValue: "10000" })
    app_id?: number;
    @Column({ type: DataType.STRING(100), comment: "\u9000\u8D27\u7C7B\u578B" })
    reason_name!: string;
