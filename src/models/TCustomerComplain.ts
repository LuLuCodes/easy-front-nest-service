...
@Table({ tableName: "t_customer_complain", timestamps: false, comment: "\u4E3E\u62A5\u6295\u8BC9\u8868" })
export class TCustomerComplain extends Model {
    ...
    @Column({ type: DataType.INTEGER, comment: "\u4E3E\u62A5\u7C7B\u578B\uFF081\u53D1\u5E7F\u544A\uFF0C2\u9A9A\u6270\u8C29\u9A82\uFF0C3\u865A\u5047\u7167\u7247\uFF0C4\u8272\u60C5\u4F4E\u4FD7\uFF0C5TA\u662F\u9A97\u5B50\uFF09" })
    ...
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u5904\u7406\u72B6\u6001\uFF080\u5F85\u5904\u7406 10\u5DF2\u5904\u7406\uFF09" })
    deal_status?: number;
