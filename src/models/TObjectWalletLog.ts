...
@Table({ tableName: "t_object_wallet_log", timestamps: false, comment: "\u5BF9\u8C61\u94B1\u5305\u6D41\u6C34\u8868" })
export class TObjectWalletLog extends Model {
    ...
    wallet_id!: number;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u6D41\u6C34\u91D1\u989D\uFF08\u6B63\u53F7\u589E\u52A0\uFF0C\u8D1F\u53F7\u51CF\u5C11\uFF09", defaultValue: "0.00" })
    amount?: string;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u5F53\u524D\u94B1\u5305\u4F59\u989D", defaultValue: "0.00" })
    now_wallet_amount?: string;
    @Column({ type: DataType.INTEGER, comment: "\u6D41\u6C34\u7C7B\u578B\uFF081\u5956\u52B1 2\u63D0\u73B0 3\u9000\u6B3E 4\u6D88\u8D39\u2026\u2026\uFF09" })
    log_type!: number;
    @Column({ type: DataType.STRING(200), comment: "\u6D41\u6C34\u6807\u9898" })
    log_title!: string;
    @Column({ allowNull: true, type: DataType.STRING(500), comment: "\u5185\u5BB9\u63CF\u8FF0" })
    log_desc?: string;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u6765\u6E90\uFF081\u8BA2\u5355\uFF0C2\u5145\u503C\u5355 3\u53D1\u8D27\u5355\uFF09" })
    source_type?: number;
    @Column({ allowNull: true, type: DataType.BIGINT, comment: "\u6765\u6E90\u7F16\u7801\uFF081\u8BA2\u5355\u7F16\u7801\uFF0C2\u5145\u503C\u5355\u7F16\u7801\uFF0C3\u53D1\u8D27\u5355\u7F16\u7801\uFF09" })
    source_id?: number;
