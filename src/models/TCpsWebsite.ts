...
@Table({ tableName: "t_cps_website", timestamps: false, comment: "cps\u7AD9\u70B9\u548C\u6C47\u7387\u8868" })
export class TCpsWebsite extends Model {
    ...
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u5E73\u53F0\u4F63\u91D1", defaultValue: "0.00" })
    plant_rate?: string;
    @Column({ type: DataType.STRING(50), comment: "\u4E91\u56FE\u56FD\u9645\u7269\u6D41\u56FD\u5BB6\u7B80\u7801" })
    express_code!: string;
    @Column({ field: "marketplaceId", allowNull: true, type: DataType.STRING(100), comment: "\u4E9A\u9A6C\u900AMarketplaceId" })
