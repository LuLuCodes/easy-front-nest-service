...
export class TReportMoney extends Model {
    ...
    vip_in!: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u5145\u503C\u8C46\u8C46\u5E01\u603B\u6536\u5165", defaultValue: "0.00" })
    doudou_in?: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u7EA6\u4F1A\u624B\u7EED\u8D39\u603B\u6536\u5165" })
    meeting_in!: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u76F8\u518C\u624B\u7EED\u8D39\u603B\u6536\u5165" })
    photo_in!: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u804A\u5929\u624B\u7EED\u8D39\u603B\u6536\u5165", defaultValue: "0.00" })
    chat_in?: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u5206\u4EAB\u83B7\u76CA\u652F\u51FA" })
    share_out!: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u63D0\u73B0\u603B\u652F\u51FA", defaultValue: "0.00" })
    cash_out?: string;
