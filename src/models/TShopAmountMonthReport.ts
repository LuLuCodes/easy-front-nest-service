...
@Table({ tableName: "t_shop_amount_month_report", timestamps: false, comment: "\u5E97\u94FA\u6BCF\u6708\u5206\u914D\u62A5\u8868" })
export class TShopAmountMonthReport extends Model {
    ...
    report_month!: Date;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u5237\u5355\u6210\u672C\u672C\u6708\u62B5\u6263", defaultValue: "0.00" })
    has_sd_const?: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u5237\u5355\u6210\u672C\u672A\u62B5\u6263", defaultValue: "0.00" })
