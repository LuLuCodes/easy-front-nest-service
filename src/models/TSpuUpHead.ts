...
@Table({ tableName: "t_spu_up_head", timestamps: false, comment: "\u5546\u54C1\u4E0A\u4F20\u4EFB\u52A1\u4E3B\u8868" })
export class TSpuUpHead extends Model {
    ...
    title?: string;
    @Column({ type: DataType.INTEGER, comment: "\u4E0A\u4F20\u9009\u54C1\uFF081\u540E\u53F0\u4EBA\u5DE5\u9009\u53D6\uFF0C2\u667A\u80FD\u81EA\u52A8\u9009\u53D6\uFF0C3\u6309\u5E97\u94FA\u6388\u6743\u7C7B\u9009\u53D6\uFF09", defaultValue: "1" })
    up_type?: number;
    @Column({ allowNull: true, type: DataType.STRING, comment: "\u6DD8\u5B9D\u7C7B\u522B\u6570\u7EC4\uFF08\u2018,\u2019\u5206\u9694\uFF09" })
    category_ids?: string;
    @Column({ allowNull: true, type: DataType.STRING, comment: "\u7C7B\u522B\u8DEF\u5F84" })
    category_path?: string;
    @Column({ type: DataType.INTEGER, comment: "\u4E0A\u4F20\u72B6\u6001\uFF080\u5F85\u4E0A\u4F20 1\u4E0A\u4F20\u4E2D 2\u5168\u90E8\u4E0A\u4F20\u6210\u529F 11\u5168\u90E8\u4E0A\u4F20\u5931\u8D25 12\u90E8\u5206\u5931\u8D25\uFF09", defaultValue: "0" })
    up_status?: number;
    ...
    price_up!: string;
    @Column({ type: DataType.INTEGER, comment: "\u6293\u53D6\u6307\u4EE4\u662F\u5426\u4E0B\u53D1\u5931\u8D25\uFF080\u6210\u529F 1\u5931\u8D25\uFF09", defaultValue: "0" })
    has_error?: number;
    @Column({ allowNull: true, type: DataType.STRING, comment: "\u6293\u53D6\u6307\u4EE4\u5931\u8D25\u5907\u6CE8" })
    error_remark?: string;
    @Column({ type: DataType.INTEGER, comment: "\u6293\u53D6\u662F\u5426\u5B8C\u6210", defaultValue: "0" })
    if_pick_finish?: number;
    @Column({ type: DataType.INTEGER, comment: "\u8F93\u5165\u6293\u53D6\u539F\u59CB\u6570\u91CF", defaultValue: "0" })
