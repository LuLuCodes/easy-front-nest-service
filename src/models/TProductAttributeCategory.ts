...
@Table({ tableName: "t_product_attribute_category", timestamps: false, comment: "\u5546\u54C1\u5C5E\u6027\u5206\u7C7B\u8868" })
export class TProductAttributeCategory extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u5546\u54C1\u5C5E\u6027\u5206\u7C7B\u4E3B\u952E" })
    ...
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u5C5E\u6027\u6570\u91CF", defaultValue: "0" })
    attribute_count?: number;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u53C2\u6570\u6570\u91CF", defaultValue: "0" })
    param_count?: number;
