...
@Table({ tableName: "t_meeting_complain", timestamps: false, comment: "\u7EA6\u4F1A\u6295\u8BC9\u8868" })
export class TMeetingComplain extends Model {
    ...
    id?: number;
    @Column({ allowNull: true, type: DataType.BIGINT, comment: "\u9879\u76EE\u7F16\u7801", defaultValue: "10000" })
    app_id?: number;
    ...
    @Column({ type: DataType.INTEGER, comment: "\u6295\u8BC9\u7C7B\u578B\uFF081\u5BF9\u65B9\u723D\u7EA6 2\u7167\u7247\u4E0E\u672C\u4EBA\u5DEE\u8DDD\u8FC7\u5927 3\u8BC8\u9A97\u7B49\u8FDD\u6CD5\u884C\u4E3A\uFF09", defaultValue: "0" })
    complain_type?: number;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u662F\u5426\u9000\u6B3E\uFF08\u94B1\u662F\u5426\u5DF2\u81EA\u52A8\u9000\u7ED9\u7537\u58EB\uFF09" })
    is_rma?: number;
    @Column({ allowNull: true, type: DataType.STRING(2000), comment: "\u6295\u8BC9\u5185\u5BB9" })
    content?: string;
    @Column({ allowNull: true, type: DataType.STRING(2000), comment: "\u6295\u8BC9\u622A\u56FE" })
    url_obj?: string;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u6295\u8BC9\u72B6\u6001\uFF080\u5F85\u5904\u7406 1\u5973\u65B9\u80DC 2\u7537\u65B9\u80DC\uFF09" })
    com_status?: number;
