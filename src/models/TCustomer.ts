...
export class TCustomer extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u7528\u6237\u4E3B\u952E" })
    ...
    @Column({ type: DataType.INTEGER, comment: "\u5BA2\u6237\u6765\u6E90\uFF080\u666E\u901A\u5BA2\u6237 1\u4EE3\u8D2D\u4EBA\u5458  2\u4EE3\u7406\u5546 3\u770B\u677F\u7BA1\u7406\u8005\uFF09", defaultValue: "0" })
    source_type?: number;
    ...
    phone?: string;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u7528\u6237\u7B49\u7EA7", defaultValue: "0" })
    ...
    vip_expire?: Date;
    @Column({ type: DataType.INTEGER, comment: "VIP\u84C4\u6C34\u65F6\u95F4\uFF08\u5929\uFF09", defaultValue: "0" })
    vip_save_days?: number;
    @Column({ type: DataType.TINYINT, comment: "\u662F\u5426\u6E38\u5BA2", defaultValue: "0" })
    is_tour?: number;
    @Column({ type: DataType.TINYINT, comment: "\u5728\u7EBF\u72B6\u6001\uFF080\u79BB\u7EBF 1\u5728\u7EBF\uFF09", defaultValue: "0" })
    online_status?: number;
    @Column({ allowNull: true, type: DataType.DATE, comment: "\u6700\u540E\u5FC3\u8DF3\u65F6\u95F4" })
    beet_time?: Date;
    @Column({ type: DataType.INTEGER, comment: "\u767B\u5F55\u72B6\u6001\uFF080\u767B\u51FA 1\u767B\u5165\uFF09", defaultValue: "0" })
    login_status?: number;
