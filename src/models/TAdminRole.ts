...
@Table({ tableName: "t_admin_role", timestamps: false, comment: "\u540E\u53F0\u7528\u6237\u89D2\u8272\u8868" })
export class TAdminRole extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u89D2\u8272\u4E3B\u952E" })
    ...
    desc?: string;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u540E\u53F0\u7528\u6237\u6570\u91CF", defaultValue: "0" })
    admin_count?: number;
    @Column({ type: DataType.INTEGER, comment: "\u89D2\u8272\u6765\u6E90\uFF080\u5E73\u53F0\u540E\u53F0 1\u5546\u5BB6\u540E\u53F0\uFF09", defaultValue: "0" })
    source_type?: number;
    @Column({ type: DataType.BIGINT, comment: "\u89D2\u8272\u6765\u6E90\u7F16\u7801", defaultValue: "0" })
    source_id?: number;
    @Column({ type: DataType.INTEGER, comment: "\u662F\u5426\u7CFB\u7EDF\u89D2\u8272", defaultValue: "0" })
    is_system?: number;
