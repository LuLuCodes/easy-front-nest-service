...
@Table({ tableName: "t_customer_coupon_history", timestamps: false, comment: "\u7528\u6237\u4F18\u60E0\u5238\u4F7F\u7528\u9886\u53D6\u8868" })
export class TCustomerCouponHistory extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u7528\u6237\u4F18\u60E0\u5238\u4E3B\u952E(\u81EA\u589E)" })
    ...
    order_id?: string;
    @Column({ allowNull: true, type: DataType.TINYINT, comment: "\u83B7\u53D6\u7C7B\u578B\uFF1A0->\u540E\u53F0\u8D60\u9001\uFF1B1->\u4E3B\u52A8\u83B7\u53D6", defaultValue: "0" })
    @Index({ name: "idx_get_type", using: "BTREE", order: "ASC", unique: false })
    get_type?: number;
    @Column({ allowNull: true, type: DataType.TINYINT, comment: "\u4F7F\u7528\u72B6\u6001\uFF1A0->\u672A\u4F7F\u7528\uFF1B1->\u5DF2\u4F7F\u7528\uFF1B2->\u5DF2\u8FC7\u671F", defaultValue: "0" })
    @Index({ name: "idx_use_status", using: "BTREE", order: "ASC", unique: false })
    use_status?: number;
