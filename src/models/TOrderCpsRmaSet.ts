...
@Table({ tableName: "t_order_cps_rma_set", timestamps: false, comment: "\u8BA2\u5355\u4E09\u65B9\u7ED3\u7B97\u624B\u5DE5\u552E\u540E\u8868" })
export class TOrderCpsRmaSet extends Model {
    ...
    report_day!: Date;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u552E\u540E\u91D1\u989D", defaultValue: "0.00" })
    rma_amount?: string;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u552E\u540E\u6210\u672C", defaultValue: "0.00" })
    rma_const?: string;
