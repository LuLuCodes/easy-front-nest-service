...
@Table({ tableName: "t_purchase_report", timestamps: false, comment: "\u91C7\u8D2D\u8BB0\u5F55\u62A5\u8868" })
export class TPurchaseReport extends Model {
    ...
    purchase_sn?: string;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u91C7\u8D2D\u91D1\u989D", defaultValue: "0.00" })
    purchase_amount?: string;
    @Column({ type: DataType.DECIMAL(18,2), comment: "\u91C7\u8D2D\u5907\u7528\u91D1", defaultValue: "0.00" })
