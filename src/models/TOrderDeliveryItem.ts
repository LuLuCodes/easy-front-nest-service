...
export class TOrderDeliveryItem extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u53D1\u8D27\u5355\u660E\u7EC6\u4E3B\u952E" })
    ...
    @Index({ name: "idx_delivery_id", using: "BTREE", order: "ASC", unique: false })
    delivery_id!: number;
    ...
    @Index({ name: "idx_ order_item_id", using: "BTREE", order: "ASC", unique: false })
