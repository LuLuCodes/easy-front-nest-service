...
@Table({ tableName: "t_flash_promotion_session", timestamps: false, comment: "\u9650\u65F6\u8D2D\u573A\u6B21\u8868" })
export class TFlashPromotionSession extends Model {
    ...
    @Column({ allowNull: true, type: DataType.STRING(50), comment: "\u573A\u6B21\u540D\u79F0" })
    @Index({ name: "idx_flash_promotion_session_name", using: "BTREE", order: "ASC", unique: false })
