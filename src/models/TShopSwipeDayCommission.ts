...
@Table({ tableName: "t_shop_swipe_day_commission", timestamps: false, comment: "\u5E97\u94FA\u5237\u5355-\u4E0A\u62A5\u5237\u5355\u4F63\u91D1\u8868" })
export class TShopSwipeDayCommission extends Model {
    ...
    shop_id!: number;
    @Column({ allowNull: true, type: DataType.DATE, comment: "\u4E0A\u62A5\u65F6\u95F4" })
    @Index({ name: "idx_report_day", using: "BTREE", order: "ASC", unique: false })
    report_day?: Date;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u4E0A\u62A5\u4F63\u91D1", defaultValue: "0.00" })
    commission?: string;
