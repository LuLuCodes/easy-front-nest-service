...
@Table({ tableName: "t_customer_recharge_conf", timestamps: false, comment: "\u5BA2\u6237\u5145\u503C\u914D\u7F6E" })
export class TCustomerRechargeConf extends Model {
    ...
    recharge_url!: string;
    @Column({ type: DataType.INTEGER, comment: "\u5145\u503C\u7C7B\u578B\uFF081vip\u5145\u503C\u8BA2\u5355  2\u5145\u503C\u8C46\u8C46\u5E01 3\u5BF9\u8C61\u94B1\u5305t_object_wallet\uFF09" })
    recharge_type!: number;
    @Column({ type: DataType.INTEGER, comment: "\u5145\u503C\u65F6\u6548\uFF0810 10\u5929\uFF0C30 \u4E00\u4E2A\u6708\uFF0C90\u4E09\u4E2A\u6708 180 \u516D\u4E2A\u6708 \uFF09" })
    useful_type!: number;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u5145\u503C\u91D1\u989D" })
    amount!: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u539F\u4EF7", defaultValue: "0.00" })
