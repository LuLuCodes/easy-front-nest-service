...
@Table({ tableName: "t_customer_cashout", timestamps: false, comment: "\u5BA2\u6237\u63D0\u73B0\u8868" })
export class TCustomerCashout extends Model {
    @Column({ primaryKey: true, autoIncrement: true, type: DataType.BIGINT, comment: "\u4E3B\u952E(\u81EA\u589E)" })
    ...
    wallet_id!: number;
    @Column({ allowNull: true, type: DataType.STRING(100), comment: "\u5546\u6237\u63D0\u73B0\u6D41\u6C34\u53F7" })
    cash_no?: string;
    @Column({ allowNull: true, type: DataType.INTEGER, comment: "\u63D0\u73B0\u8D26\u53F7\u7C7B\u578B\uFF081\u5FAE\u4FE1 2\u652F\u4ED8\u5B9D 3\u94F6\u884C\u5361\uFF09" })
    cash_type?: number;
    @Column({ allowNull: true, type: DataType.STRING(200), comment: "\u63D0\u73B0\u76EE\u6807\u8D26\u53F7\uFF08\u5FAE\u4FE1open_id,\u652F\u4ED8\u5B9D\u8D26\u53F7,\u94F6\u884C\u5361\u53F7\uFF09" })
    cash_account?: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u7533\u8BF7\u63D0\u73B0\u91D1\u989D" })
    amount!: string;
    @Column({ type: DataType.DECIMAL(10,2), comment: "\u6700\u7EC8\u5230\u8D26\u91D1\u989D\uFF08\u6263\u9664\u624B\u7EED\u8D39\uFF09" })
    success_amount!: string;
    @Column({ type: DataType.INTEGER, comment: "\u72B6\u6001\uFF080\u5DF2\u7533\u8BF7 1\u63D0\u73B0\u4E2D 10\u5DF2\u5230\u8D26 11\u5931\u8D25\uFF09", defaultValue: "0" })
    out_status?: number;
    @Column({ allowNull: true, type: DataType.STRING(500), comment: "\u7533\u8BF7\u5907\u6CE8" })
    apply_remark?: string;
    @Column({ type: DataType.INTEGER, comment: "\u5BA1\u6838\u72B6\u6001\uFF080\u672A\u5BA1\u6838 10\u5DF2\u5BA1\u6838 11\u5BA1\u6838\u4E0D\u901A\u8FC7\uFF09", defaultValue: "0" })
    audit_status?: number;
    @Column({ allowNull: true, type: DataType.BIGINT, comment: "\u5BA1\u6838\u4EBA" })
    audit_id?: number;
    @Column({ allowNull: true, type: DataType.DATE, comment: "\u5BA1\u6838\u65F6\u95F4" })
    audit_time?: Date;
    @Column({ allowNull: true, type: DataType.STRING(500), comment: "\u5BA1\u6838\u5907\u6CE8\uFF08\u7B2C\u4E09\u65B9\u6253\u6B3E\u5931\u8D25\u4E5F\u4FDD\u5B58\u5728\u8FD9\u91CC\uFF09" })
    deal_remark?: string;
